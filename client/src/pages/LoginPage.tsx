  ...
  return (
    <div className="app-shell flex min-h-screen items-center justify-center px-4 py-10 text-slate-100">
      <div className="surface w-full max-w-md rounded-2xl p-7 backdrop-blur-md">
        ...
        <p className="mt-2 text-sm leading-6 text-slate-400">Sign in to access your private journal, trades, and analytics.</p>

        <div className="mt-5 rounded-xl border border-sky-400/20 bg-sky-500/10 px-4 py-3 text-sm text-sky-100">
        ...
        <form className="mt-6 space-y-4" onSubmit={handleSubmit}>
          ...
          <label className="block space-y-2 text-sm text-slate-300">
            <span>Password</span>
            <input value={password} onChange={(event) => setPassword(event.target.value)} type="password" autoComplete="current-password" className="field-control w-full rounded-xl px-4 py-3 text-white outline-none transition" />
          </label>
